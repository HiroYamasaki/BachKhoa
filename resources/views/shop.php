...
<head>
	...
	<title>Sản Phẩm &#8211; BachKhoa Digital</title>
							...
							<div class="mkd-position-center-inner">
								...
								<nav class="mkd-main-menu mkd-drop-down mkd-default-nav">
									<ul id="menu-main-menu-navigation" class="clearfix">
										<li id="nav-menu-item-379" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub narrow"><a href="#" class=""><span class="item_outer"><span class="item_text">Home</span><i class="mkd-menu-arrow fa fa-angle-down"></i></span></a>
											<div class="second">
												<div class="inner">
													<ul>
										...
										<li id="nav-menu-item-383" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children mkd-active-item has_sub narrow"><a href="#" class=" current "><span class="item_outer"><span class="item_text">Shop</span><i class="mkd-menu-arrow fa fa-angle-down"></i></span></a>
											<div class="second">
												<div class="inner">
													<ul>
														<li id="nav-menu-item-553" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item current_page_item "><a href="https://baumeister.qodeinteractive.com/product-list/" class=""><span class="item_outer"><span class="item_text">Product List</span></span></a></li>
								...
								<div class="mkd-position-center-inner">
									...
									<nav class="mkd-main-menu mkd-drop-down mkd-sticky-nav">
										<ul id="menu-main-menu-navigation-1" class="clearfix">
											<li id="sticky-nav-menu-item-379" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub narrow"><a href="#" class=""><span class="item_outer"><span class="item_text">Home</span><span class="plus"></span><i class="mkd-menu-arrow fa fa-angle-down"></i></span></a>
												<div class="second">
													<div class="inner">
														<ul>
											...
											<li id="sticky-nav-menu-item-383" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children mkd-active-item has_sub narrow"><a href="#" class=" current "><span class="item_outer"><span class="item_text">Shop</span><span class="plus"></span><i class="mkd-menu-arrow fa fa-angle-down"></i></span></a>
												<div class="second">
													<div class="inner">
														<ul>
															<li id="sticky-nav-menu-item-553" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item current_page_item "><a href="https://baumeister.qodeinteractive.com/product-list/" class=""><span class="item_outer"><span class="item_text">Product List</span><span class="plus"></span></span></a></li>
					...
					<nav class="mkd-mobile-nav">
						<div class="mkd-grid">
							<ul id="menu-main-menu-navigation-2" class="">
								...
								<li id="mobile-menu-item-383" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children mkd-active-item has_sub"><a href="#" class=" current  mkd-mobile-no-link"><span>Shop</span></a><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
									<ul class="sub_menu">
										<li id="mobile-menu-item-553" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item current_page_item "><a href="https://baumeister.qodeinteractive.com/product-list/" class=""><span>Product List</span></a></li>
								...
								<li id="mobile-menu-item-384" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub"><a href="#" class=" mkd-mobile-no-link"><span>Elements</span></a><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
									<ul class="sub_menu">
										<li id="mobile-menu-item-1991" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub">
											<h6><span>Classic</span></h6><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
											<ul class="sub_menu">
										...
										<li id="mobile-menu-item-1992" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub">
											<h6><span>Presentation</span></h6><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
											<ul class="sub_menu">
										...
										<li id="mobile-menu-item-1993" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub">
											<h6><span>Infographic</span></h6><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
											<ul class="sub_menu">
										...
										<li id="mobile-menu-item-1994" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub">
											<h6><span>Typography</span></h6><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
											<ul class="sub_menu">
...
<div class="mkd-title-holder mkd-standard-type mkd-preload-background mkd-has-bg-image mkd-bg-parallax" style="height: 521px;background-image:url(https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-title-background-img.jpg);" data-height="521">
		...
		<div class="mkd-title-inner">
			<div class="mkd-grid">
									<h1 class="mkd-page-title entry-title" >Sản Phẩm</h1>
											</div>
	    </div>
	</div>
</div>
...
<form class="woocommerce-ordering" method="get">
	...
	<input type="hidden" name="_gl" value="1*ycdx1i*_gcl_au*NjUzNzc2NjA1LjE3NzM3MjEyNzM." /><input type="hidden" name="_ga" value="2.194129773.1745420685.1774237210-749197518.1773721273" /></form>
<div class="mkd-pl-main-holder"><ul class="products columns-4">
<li class="product type-product post-253 status-publish first instock product_cat-power-tools product_tag-home product_tag-service product_tag-technology has-post-thumbnail shipping-taxable purchasable product-type-simple">
	<div class="mkd-pl-inner"><div class="mkd-pl-image"><img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-1-800x800.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="a" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-1-800x800.jpg 800w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-1-150x150.jpg 150w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-1-195x195.jpg 195w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-1-550x550.jpg 550w" sizes="(max-width: 800px) 100vw, 800px" /><span class="mkd-new-product">New</span><div class="mkd-pl-text"><div class="mkd-pl-text-outer"><div class="mkd-pl-text-inner"><a href="?add-to-cart=253" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="253" data-product_sku="01" aria-label="Add &ldquo;Electric Drill&rdquo; to your cart" rel="nofollow">Add to cart</a></div></div></div></div><a href="https://baumeister.qodeinteractive.com/product/electric-drill/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"></a></div><div class="mkd-pl-text-wrapper"><div class="mkd-pl-title-price-holder"><h5 class="mkd-product-list-title"><a href="https://baumeister.qodeinteractive.com/product/electric-drill/">Electric Drill</a></h5>
	<span class="price"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span>199</bdi></span></span>
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 3.50 out of 5"><span style="width:70%">Rated <strong class="rating">3.50</strong> out of 5</span></div></div></div></li><li class="product type-product post-259 status-publish instock product_cat-power-tools product_tag-home product_tag-service has-post-thumbnail shipping-taxable purchasable product-type-simple">
	<div class="mkd-pl-inner"><div class="mkd-pl-image"><img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-2-800x800.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="a" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-2-800x800.jpg 800w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-2-150x150.jpg 150w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-2-195x195.jpg 195w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-2-550x550.jpg 550w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-2-300x300.jpg 300w" sizes="(max-width: 800px) 100vw, 800px" /><div class="mkd-pl-text"><div class="mkd-pl-text-outer"><div class="mkd-pl-text-inner"><a href="?add-to-cart=259" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="259" data-product_sku="02" aria-label="Add &ldquo;Electrical Wires&rdquo; to your cart" rel="nofollow">Add to cart</a></div></div></div></div><a href="https://baumeister.qodeinteractive.com/product/electrical-wires/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"></a></div><div class="mkd-pl-text-wrapper"><div class="mkd-pl-title-price-holder"><h5 class="mkd-product-list-title"><a href="https://baumeister.qodeinteractive.com/product/electrical-wires/">Electrical Wires</a></h5>
	<span class="price"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span>25</bdi></span></span>
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:80%">Rated <strong class="rating">4.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1113 status-publish instock product_cat-power-tools product_tag-home product_tag-service product_tag-technology has-post-thumbnail shipping-taxable purchasable product-type-simple">
	<div class="mkd-pl-inner"><div class="mkd-pl-image"><img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-3-800x800.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="a" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-3-800x800.jpg 800w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-3-150x150.jpg 150w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-3-195x195.jpg 195w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-3-550x550.jpg 550w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-3-300x300.jpg 300w" sizes="(max-width: 800px) 100vw, 800px" /><span class="mkd-new-product">New</span><div class="mkd-pl-text"><div class="mkd-pl-text-outer"><div class="mkd-pl-text-inner"><a href="?add-to-cart=1113" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="1113" data-product_sku="03" aria-label="Add &ldquo;Power Saw&rdquo; to your cart" rel="nofollow">Add to cart</a></div></div></div></div><a href="https://baumeister.qodeinteractive.com/product/power-saw/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"></a></div><div class="mkd-pl-text-wrapper"><div class="mkd-pl-title-price-holder"><h5 class="mkd-product-list-title"><a href="https://baumeister.qodeinteractive.com/product/power-saw/">Power Saw</a></h5>
	<span class="price"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span>350</bdi></span></span>
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1114 status-publish last instock product_cat-power-tools product_tag-home product_tag-service product_tag-technology has-post-thumbnail shipping-taxable purchasable product-type-simple">
...
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:80%">Rated <strong class="rating">4.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1115 status-publish first instock product_cat-power-tools product_tag-home product_tag-service product_tag-technology has-post-thumbnail sale shipping-taxable purchasable product-type-simple">
	<div class="mkd-pl-inner"><div class="mkd-pl-image">
	<span class="mkd-onsale">Sale</span>
	<img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-5-800x800.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="a" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-5-800x800.jpg 800w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-5-150x150.jpg 150w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-5-195x195.jpg 195w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-5-550x550.jpg 550w" sizes="(max-width: 800px) 100vw, 800px" /><div class="mkd-pl-text"><div class="mkd-pl-text-outer"><div class="mkd-pl-text-inner"><a href="?add-to-cart=1115" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="1115" data-product_sku="05" aria-label="Add &ldquo;Cargo Crane&rdquo; to your cart" rel="nofollow">Add to cart</a></div></div></div></div><a href="https://baumeister.qodeinteractive.com/product/cargo-crane/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"></a></div><div class="mkd-pl-text-wrapper"><div class="mkd-pl-title-price-holder"><h5 class="mkd-product-list-title"><a href="https://baumeister.qodeinteractive.com/product/cargo-crane/">Cargo Crane</a></h5>
	<span class="price"><del aria-hidden="true"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span>3,000</bdi></span></del> <ins><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span>1,500</bdi></span></ins></span>
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 2.00 out of 5"><span style="width:40%">Rated <strong class="rating">2.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1119 status-publish outofstock product_cat-power-tools product_tag-home product_tag-safety product_tag-service has-post-thumbnail shipping-taxable purchasable product-type-simple">
	<div class="mkd-pl-inner"><div class="mkd-pl-image"><img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-6-800x800.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="a" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-6-800x800.jpg 800w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-6-150x150.jpg 150w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-6-195x195.jpg 195w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-6-550x550.jpg 550w" sizes="(max-width: 800px) 100vw, 800px" /><span class="mkd-out-of-stock">Sold</span><div class="mkd-pl-text"><div class="mkd-pl-text-outer"><div class="mkd-pl-text-inner"><a href="https://baumeister.qodeinteractive.com/product/safety-helmet/" data-quantity="1" class="button product_type_simple" data-product_id="1119" data-product_sku="06" aria-label="Read more about &ldquo;Safety Helmet&rdquo;" rel="nofollow">Read more</a></div></div></div></div><a href="https://baumeister.qodeinteractive.com/product/safety-helmet/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"></a></div><div class="mkd-pl-text-wrapper"><div class="mkd-pl-title-price-holder"><h5 class="mkd-product-list-title"><a href="https://baumeister.qodeinteractive.com/product/safety-helmet/">Safety Helmet</a></h5>
	<span class="price"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span>45</bdi></span></span>
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:80%">Rated <strong class="rating">4.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1120 status-publish instock product_cat-power-tools product_tag-home product_tag-safety product_tag-service has-post-thumbnail shipping-taxable purchasable product-type-simple">
...
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 3.00 out of 5"><span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1121 status-publish last instock product_cat-power-tools product_tag-outdoor product_tag-safety product_tag-service has-post-thumbnail shipping-taxable purchasable product-type-simple">
	<div class="mkd-pl-inner"><div class="mkd-pl-image"><img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-8-800x800.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="a" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-8-800x800.jpg 800w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-8-150x150.jpg 150w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-8-195x195.jpg 195w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-8-550x550.jpg 550w" sizes="(max-width: 800px) 100vw, 800px" /><div class="mkd-pl-text"><div class="mkd-pl-text-outer"><div class="mkd-pl-text-inner"><a href="?add-to-cart=1121" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="1121" data-product_sku="08" aria-label="Add &ldquo;Screwdriver Pallet&rdquo; to your cart" rel="nofollow">Add to cart</a></div></div></div></div><a href="https://baumeister.qodeinteractive.com/product/screwdriver-pallet/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"></a></div><div class="mkd-pl-text-wrapper"><div class="mkd-pl-title-price-holder"><h5 class="mkd-product-list-title"><a href="https://baumeister.qodeinteractive.com/product/screwdriver-pallet/">Screwdriver Pallet</a></h5>
	<span class="price"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span>110</bdi></span></span>
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:80%">Rated <strong class="rating">4.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1122 status-publish first instock product_cat-power-tools product_tag-outdoor product_tag-service product_tag-technology has-post-thumbnail shipping-taxable purchasable product-type-simple">
	<div class="mkd-pl-inner"><div class="mkd-pl-image"><img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-9-800x800.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="a" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-9-800x800.jpg 800w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-9-150x150.jpg 150w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-9-195x195.jpg 195w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-img-9-550x550.jpg 550w" sizes="(max-width: 800px) 100vw, 800px" /><span class="mkd-new-product">New</span><div class="mkd-pl-text"><div class="mkd-pl-text-outer"><div class="mkd-pl-text-inner"><a href="?add-to-cart=1122" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="1122" data-product_sku="09" aria-label="Add &ldquo;Chain Saw&rdquo; to your cart" rel="nofollow">Add to cart</a></div></div></div></div><a href="https://baumeister.qodeinteractive.com/product/chain-saw/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"></a></div><div class="mkd-pl-text-wrapper"><div class="mkd-pl-title-price-holder"><h5 class="mkd-product-list-title"><a href="https://baumeister.qodeinteractive.com/product/chain-saw/">Chain Saw</a></h5>
	<span class="price"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span>1,500</bdi></span></span>
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1124 status-publish instock product_cat-power-tools product_tag-outdoor product_tag-service product_tag-technology has-post-thumbnail shipping-taxable purchasable product-type-simple">
...
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:80%">Rated <strong class="rating">4.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1125 status-publish instock product_cat-power-tools product_tag-storage product_tag-technology has-post-thumbnail shipping-taxable purchasable product-type-simple">
...
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5</span></div></div></div></li><li class="product type-product post-1127 status-publish last instock product_cat-power-tools product_tag-safety product_tag-storage has-post-thumbnail shipping-taxable purchasable product-type-simple">
...
</div><div class="mkd-pl-categories"><a href="https://baumeister.qodeinteractive.com/product-category/power-tools/" rel="tag">Power Tools</a></div><div class="mkd-pl-rating-holder"><div class="star-rating" role="img" aria-label="Rated 3.00 out of 5"><span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span></div></div></div></li></ul>
	...
	<li><a class="page-numbers" href="https://baumeister.qodeinteractive.com/product-list/page/2/?_gl=1%2Aycdx1i%2A_gcl_au%2ANjUzNzc2NjA1LjE3NzM3MjEyNzM.&#038;_ga=2.194129773.1745420685.1774237210-749197518.1773721273">2</a></li>
	<li><a class="next page-numbers" href="https://baumeister.qodeinteractive.com/product-list/page/2/?_gl=1%2Aycdx1i%2A_gcl_au%2ANjUzNzc2NjA1LjE3NzM3MjEyNzM.&#038;_ga=2.194129773.1745420685.1774237210-749197518.1773721273">&rarr;</a></li>
</ul>
</nav>
<div class="mkd-woo-view-all-pagination"><a href="https://baumeister.qodeinteractive.com/product-list/?woo-products-count=view-all">View All</a></div></div></div>				</div>
...
<style id="bkd-color-override">
    body.woocommerce-shop .mkd-btn.mkd-btn-solid,
    body.woocommerce-shop a.mkd-btn.mkd-btn-solid,
    body.woocommerce-shop .mkd-btn.mkd-btn-medium.mkd-btn-solid,
    body.woocommerce-shop a.mkd-btn.mkd-btn-medium.mkd-btn-solid,
    body.woocommerce-shop a.mkd-btn.mkd-btn-small.mkd-btn-solid,
    body.woocommerce-shop a.mkd-btn.mkd-btn-large.mkd-btn-solid,
    body.woocommerce-shop a.mkd-btn.mkd-btn-full-width.mkd-btn-solid,
    body.woocommerce-shop a.mkd-btn.mkd-btn-solid.mkd-btn-icon,
    body.woocommerce-shop a.mkd-btn.mkd-btn-medium.mkd-btn-solid.mkd-btn-icon {
    ...
    body.woocommerce-shop .mkd-btn.mkd-btn-solid:hover,
    body.woocommerce-shop a.mkd-btn.mkd-btn-solid:hover,
    body.woocommerce-shop a.mkd-btn.mkd-btn-medium.mkd-btn-solid:hover,
    body.woocommerce-shop a.mkd-btn.mkd-btn-full-width.mkd-btn-solid:hover {
        background-color: #C0392B !important;
        background-image: linear-gradient(135deg, #C0392B 0%, #9B1B1B 100%) !important;
        border-color: #C0392B !important;
    }
    body.woocommerce-shop .mkd-btn.mkd-btn-solid .mkd-btn-text,
    body.woocommerce-shop a.mkd-btn.mkd-btn-solid .mkd-btn-text { color: #ffffff !important; }
    body.woocommerce-shop .mkd-btn.mkd-btn-solid .mkd-btn-icon,
    body.woocommerce-shop a.mkd-btn.mkd-btn-solid .mkd-btn-icon {
        background-color: #C0392B !important;
    ...
    body.woocommerce-shop .mkd-main-menu > ul > li.mkd-active-item > a,
    body.woocommerce-shop .mkd-main-menu > ul > li.mkd-active-item > a span,
    body.woocommerce-shop .mkd-main-menu > ul > li.current-menu-item > a,
    body.woocommerce-shop .mkd-main-menu > ul > li > a:hover,
    body.woocommerce-shop .mkd-main-menu > ul > li > a:hover span { color: #E8612D !important; }
    body.woocommerce-shop .mkd-main-menu > ul > li.mkd-active-item > a::after,
    body.woocommerce-shop .mkd-main-menu > ul > li > a:hover::after { background-color: #E8612D !important; }

    body.woocommerce-shop .mkd-drop-down .second .inner ul li a:hover,
    body.woocommerce-shop .mkd-drop-down .second .inner ul li.current-menu-item > a { color: #E8612D !important; }

    body.woocommerce-shop .mkd-post-info-category a,
    body.woocommerce-shop .mkd-post-info-category a:hover { color: #ffffff !important; background-color: #E8612D !important; border-color: #E8612D !important; }
    body.woocommerce-shop .mkd-post-info-author .mkd-post-info-author-link,
    body.woocommerce-shop a.mkd-post-info-author-link { color: #E8612D !important; }

    body.woocommerce-shop .mkd-st-title-line { background-color: #E8612D !important; }
    body.woocommerce-shop .woocommerce span.onsale { background-color: #E8612D !important; }
