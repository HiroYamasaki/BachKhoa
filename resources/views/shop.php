...
<form class="woocommerce-ordering" method="get" action="/shop">
	<select name="orderby" class="orderby" aria-label="Shop order" onchange="this.form.submit()">
					...
					<option value="price-desc" <?php echo $orderby == 'price-desc' ? "selected='selected'" : ''; ?>>Sort by price: high to low</option>
					<option value="name" <?php echo $orderby == 'name' ? "selected='selected'" : ''; ?>>Sort by name: A to Z</option>
...
<div class="mkd-woo-pagination-holder"><div class="mkd-woo-pagination-inner"><nav class="woocommerce-pagination">
	...
	<?php else: ?>
	<li><a class="page-numbers" href="<?php echo htmlspecialchars($products->url($i)); ?>"><?php echo $i; ?></a></li>
	<?php endif; ?>
	<?php endfor; ?>
