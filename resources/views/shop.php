...
<head>
	...
	<meta property="og:url" content="<?php echo $ogBase; ?>/shop"/>
	<meta property="og:title" content="Sản Phẩm – BachKhoa Digital"/>
	<meta property="og:description" content="Khám phá các sản phẩm và giải pháp công nghệ chất lượng cao từ BachKhoa Digital."/>
	<meta property="og:image" content="<?php echo $ogBase; ?>/images/share.jpg"/>
	<meta property="og:image:width" content="1200"/>
	<meta property="og:image:height" content="630"/>
	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary_large_image"/>
	<meta name="twitter:title" content="Sản Phẩm – BachKhoa Digital"/>
	<meta name="twitter:description" content="Khám phá các sản phẩm và giải pháp công nghệ chất lượng cao từ BachKhoa Digital."/>
					...
					<div class="mkd-title-holder mkd-standard-type mkd-preload-background mkd-has-bg-image mkd-bg-parallax" style="height: 521px;background-image:url(https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/shop-title-background-img.jpg);" data-height="521">
						...
						<div class="mkd-title-wrapper" style="height: 521px;padding-top: 80px">
							<div class="mkd-title-inner">
								<div class="mkd-grid">
									<h1 class="mkd-page-title entry-title" style="color: #ffffff">Sản Phẩm</h1>
								</div>
							</div>
						</div>
					</div>
