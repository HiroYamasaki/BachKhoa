												...
												<div class="inner">
													<ul>
														<li id="nav-menu-item-2364" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children sub"><a href="#" class=""><span class="item_outer"><span class="item_text">Standard</span></span></a>
															<ul>
																<li id="nav-menu-item-2367" class="menu-item menu-item-type-post_type menu-item-object-page "><a href="/projects" class=""><span class="item_outer"><span class="item_text">In Grid</span></span></a></li>
		...
		<div class="mkd-title-inner">
			<div class="mkd-grid">
				<div class="mkd-title-info">
					<h1 class="mkd-page-title entry-title" style="color: #ffffff">Dự Án Sáng Tạo</h1>
				</div>
				<div class="mkd-breadcrumbs-info">
					<div itemprop="breadcrumb" class="mkd-breadcrumbs "><a itemprop="url" href="/">Home</a><span class="mkd-delimiter">&nbsp; / &nbsp;</span><a itemprop="url" href="/projects">Dự Án</a><span class="mkd-delimiter">&nbsp; / &nbsp;</span><span class="mkd-current">Dự Án Sáng Tạo</span></div>
				</div>
			</div>
	    </div>
	</div>
        ...
        <div class="mkd-portfolio-single-holder mkd-ps-small-images-layout">
                    ...
                    <div class="mkd-ps-image-holder">
                        <div class="mkd-ps-image-inner">
                            <div class="mkd-ps-image">
                                <a itemprop="image" title="h2-port-gallery-img-1" data-rel="prettyPhoto[single_pretty_photo]" href="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-gallery-img-1.jpg">
                                    <img itemprop="image" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-gallery-img-1.jpg" alt="Dự Án Sáng Tạo" />
                                </a>
                            </div>
                            <div class="mkd-ps-image">
                                <a itemprop="image" title="h2-port-gallery-img-2" data-rel="prettyPhoto[single_pretty_photo]" href="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-gallery-img-2.jpg">
                                    <img itemprop="image" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-gallery-img-2.jpg" alt="Dự Án Sáng Tạo" />
                                </a>
                            </div>
                            <div class="mkd-ps-image">
                                <a itemprop="image" title="h2-port-gallery-img-3" data-rel="prettyPhoto[single_pretty_photo]" href="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-gallery-img-3.jpg">
                                    <img itemprop="image" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-gallery-img-3.jpg" alt="Dự Án Sáng Tạo" />
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mkd-grid-col-4">
                    <div class="mkd-ps-info-holder mkd-ps-info-sticky-holder">
                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_text_column wpb_content_element">
                                                    <div class="wpb_wrapper">
                                                        <h3>Mô Hình Sáng Tạo</h3>
                                                    </div>
                                                </div>
                                                <div class="wpb_text_column wpb_content_element" style="padding-top: 17px;">
                                                    <div class="wpb_wrapper">
                                                        <p>BachKhoa Digital mang đến giải pháp công nghệ sáng tạo, tối ưu hóa hạ tầng mạng và hệ thống an ninh cho doanh nghiệp. Chúng tôi cam kết chất lượng dịch vụ hàng đầu với đội ngũ kỹ sư chuyên nghiệp và giàu kinh nghiệm.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="mkd-ps-info-item mkd-ps-categories">
                            <h4 class="mkd-ps-info-title">Danh Mục:</h4>
                            <a itemprop="url" class="mkd-ps-info-category" href="/projects">Xây Dựng</a>
                            <a itemprop="url" class="mkd-ps-info-category" href="/projects">Công Nghệ</a>
                        </div>
                        <div class="mkd-ps-info-item mkd-ps-date">
                            <h4 class="mkd-ps-info-title">Ngày:</h4>
                            <p itemprop="dateCreated" class="mkd-ps-info-date entry-date updated">Tháng 11, 2024</p>
                        </div>
                        <div class="mkd-ps-info-item mkd-ps-tags">
                            <h4 class="mkd-ps-info-title">Thẻ:</h4>
                            <a itemprop="url" class="mkd-ps-info-tag" href="/projects">Công Nghệ</a>
                            <a itemprop="url" class="mkd-ps-info-tag" href="/projects">Hạ Tầng</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mkd-ps-navigation">
                <div class="mkd-ps-prev">
                    <a href="/project-detail" rel="prev"><span class="mkd-ps-nav-mark ion-ios-arrow-thin-left"></span></a>
                </div>
                ...
                <div class="mkd-ps-next">
                    <a href="/project-detail" rel="next"><span class="mkd-ps-nav-mark ion-ios-arrow-thin-right"></span></a>
                </div>
            </div>
        </div>
    </div>
...
<style id="bkd-color-override">
    body.postid-1283 .mkd-btn.mkd-btn-solid,
    body.postid-1283 a.mkd-btn.mkd-btn-solid {
    ...
    body.postid-1283 .mkd-btn.mkd-btn-solid:hover,
    body.postid-1283 a.mkd-btn.mkd-btn-solid:hover {
        background-color: #C0392B !important;
        background-image: linear-gradient(135deg, #C0392B 0%, #9B1B1B 100%) !important;
        border-color: #C0392B !important;
    }
    body.postid-1283 .mkd-btn.mkd-btn-solid .mkd-btn-text { color: #ffffff !important; }
    body.postid-1283 .mkd-btn.mkd-btn-solid .mkd-btn-icon {
        background-color: #C0392B !important;
        color: #ffffff !important;
    }

    body.postid-1283 .mkd-main-menu > ul > li.mkd-active-item > a,
    body.postid-1283 .mkd-main-menu > ul > li.mkd-active-item > a span,
    body.postid-1283 .mkd-main-menu > ul > li.current-menu-item > a,
    body.postid-1283 .mkd-main-menu > ul > li > a:hover,
    body.postid-1283 .mkd-main-menu > ul > li > a:hover span { color: #E8612D !important; }
    body.postid-1283 .mkd-main-menu > ul > li.mkd-active-item > a::after,
    body.postid-1283 .mkd-main-menu > ul > li > a:hover::after { background-color: #E8612D !important; }

    body.postid-1283 .mkd-drop-down .second .inner ul li a:hover,
    body.postid-1283 .mkd-drop-down .second .inner ul li.current-menu-item > a { color: #E8612D !important; }

    body.postid-1283 .mkd-st-title-line { background-color: #E8612D !important; }

    body.postid-1283 .mkd-back-to-top a,
    body.postid-1283 #mkd-back-to-top a { background-color: #E8612D !important; }

    body.postid-1283 .mkd-page-footer,
    body.postid-1283 .mkd-footer-top-holder,
    body.postid-1283 .mkd-footer-bottom-holder { background-color: #2B2B2B !important; }
    body.postid-1283 .mkd-footer-top-holder *,
    body.postid-1283 .mkd-footer-bottom-holder * { color: #cccccc !important; }
    body.postid-1283 .mkd-widget-title,
    body.postid-1283 .mkd-footer-top-holder h4,
    body.postid-1283 .mkd-footer-bottom-holder h4 { color: #ffffff !important; }
    body.postid-1283 .mkd-footer-top-holder a:hover,
    body.postid-1283 .mkd-footer-bottom-holder a:hover { color: #E8612D !important; }

    body.postid-1283 .mkd-ps-info-title { color: #E8612D !important; }
    body.postid-1283 .mkd-ps-info-category:hover,
    body.postid-1283 .mkd-ps-info-tag:hover { color: #E8612D !important; }
    body.postid-1283 .mkd-ps-navigation .mkd-ps-back-btn a:hover .social_flickr { background-color: #E8612D !important; }
</style>
