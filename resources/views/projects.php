...
<head>
	...
	<title>Dự Án &#8211; BachKhoa Digital</title>
							...
							<div class="mkd-position-center-inner">
								...
								<nav class="mkd-main-menu mkd-drop-down mkd-default-nav">
									<ul id="menu-main-menu-navigation" class="clearfix">
										...
										<li id="nav-menu-item-381" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children mkd-active-item has_sub narrow"><a href="/projects" class=" current "><span class="item_outer"><span class="item_text">Portfolio</span><i class="mkd-menu-arrow fa fa-angle-down"></i></span></a>
											<div class="second">
												<div class="inner">
													<ul>
														<li id="nav-menu-item-2364" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children sub"><a href="#" class=""><span class="item_outer"><span class="item_text">Standard</span></span></a>
															<ul>
																<li id="nav-menu-item-2367" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item current_page_item "><a href="/projects" class=""><span class="item_outer"><span class="item_text">In Grid</span></span></a></li>
										...
										<li id="nav-menu-item-382" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has_sub narrow"><a href="/blog" class=""><span class="item_outer"><span class="item_text">Blog</span><i class="mkd-menu-arrow fa fa-angle-down"></i></span></a>
											<div class="second">
												<div class="inner">
													<ul>
							...
							<div class="mkd-position-right-inner">
								...
								<div class="mkd-shopping-cart-holder" style="padding: 0 24px 0 10px">
									<div class="mkd-shopping-cart-inner">
										<a itemprop="url" class="mkd-header-cart" href="/shop">
...
<nav class="mkd-main-menu mkd-drop-down mkd-sticky-nav">
	<ul id="menu-main-menu-navigation-1" class="clearfix">
		...
		<li id="sticky-nav-menu-item-381" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children mkd-active-item has_sub narrow"><a href="/projects" class=" current "><span class="item_outer"><span class="item_text">Portfolio</span><span class="plus"></span><i class="mkd-menu-arrow fa fa-angle-down"></i></span></a>
			<div class="second"><div class="inner"><ul>
				<li id="sticky-nav-menu-item-2367" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item current_page_item "><a href="/projects" class=""><span class="item_outer"><span class="item_text">In Grid</span><span class="plus"></span></span></a></li>
			</ul></div></div>
		</li>
		<li id="sticky-nav-menu-item-382" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has_sub narrow"><a href="/blog" class=""><span class="item_outer"><span class="item_text">Blog</span><span class="plus"></span><i class="mkd-menu-arrow fa fa-angle-down"></i></span></a>
			<div class="second"><div class="inner"><ul>
					...
					<nav class="mkd-mobile-nav">
						<div class="mkd-grid">
							<ul id="menu-main-menu-navigation-2" class="">
								...
								<li id="mobile-menu-item-381" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children mkd-active-item has_sub"><a href="/projects" class=" current  mkd-mobile-no-link"><span>Portfolio</span></a><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
									<ul class="sub_menu">
								...
								<li id="mobile-menu-item-382" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has_sub"><a href="/blog" class=""><span>Blog</span></a><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
									<ul class="sub_menu">
		...
		<div class="mkd-title-inner">
			<div class="mkd-grid">
				<div class="mkd-title-info">
					<h1 class="mkd-page-title entry-title" style="color: #ffffff">Dự Án</h1>
				</div>
				<div class="mkd-breadcrumbs-info">
					<div itemprop="breadcrumb" class="mkd-breadcrumbs "><a itemprop="url" href="/">Home</a><span class="mkd-delimiter">&nbsp; / &nbsp;</span><span class="mkd-current">Dự Án</span></div>
				</div>
			</div>
	    </div>
	</div>
...
<div class="mkd-full-width">
		...
		<div class="mkd-grid-row">
			<div class="mkd-page-content-holder mkd-grid-col-12">
				<section class="wpb-content-wrapper">
					<div class="mkd-row-grid-section-wrapper mkd-content-aligment-center">
						<div class="mkd-row-grid-section">
							<div class="vc_row wpb_row vc_row-fluid vc_custom_1512565803756">
								<div class="wpb_column vc_column_container vc_col-sm-12">
									<div class="vc_column-inner">
										<div class="wpb_wrapper">
											<div class="mkd-portfolio-list-holder mkd-pl-gallery mkd-normal-space mkd-pl-three-columns mkd-pl-standard-shader mkd-pl-pag-load-more mkd-pl-has-filter" data-type="gallery" data-number-of-columns="3" data-space-between-items="normal" data-number-of-items="12" data-image-proportions="full" data-item-style="standard-shader" data-enable-title="yes" data-title-tag="h4" data-enable-category="yes" data-pagination-type="load-more" data-filter="yes" data-filter-order-by="name" data-filter-bottom-margin="35px">
		<div class="mkd-pl-filter-holder" style="margin-bottom: 35px">
		<div class="mkd-plf-inner">
			<ul>
				<li class="mkd-pl-filter" data-filter="">
					<span>Tất Cả</span>
				</li>
				<li class="mkd-pl-filter" data-filter=".portfolio-category-projects">
					<span>Dự Án</span>
				</li>
				<li class="mkd-pl-filter" data-filter=".portfolio-category-technology">
					<span>Công Nghệ</span>
				</li>
			</ul>
		</div>
	...
	<div class="mkd-pl-inner mkd-outer-space clearfix">
		<article class="mkd-pl-item mkd-item-space post-1283 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-technology">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1100" height="1100" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-1.jpg" class="attachment-full size-full wp-post-image" alt="Innovative Project" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Innovative Project</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Technology</span>
					</div>
				</div>
			</div>
		</div>
		<a itemprop="url" class="mkd-pli-link mkd-block-drag-link" href="#" target="_self"></a>
	</div>
</article>
<article class="mkd-pl-item mkd-item-space post-1296 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-technology">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-2.jpg" class="attachment-full size-full wp-post-image" alt="New Structures" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">New Structures</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Technology</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-1719 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-technology">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1100" height="1100" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-3.jpg" class="attachment-full size-full wp-post-image" alt="Construction Sites" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Construction Sites</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Technology</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-1721 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-projects">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1100" height="1100" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-4.jpg" class="attachment-full size-full wp-post-image" alt="Heavy Equipment" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Heavy Equipment</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Projects</span>
					</div>
				</div>
			</div>
		</div>
...
<article class="mkd-pl-item mkd-item-space post-1724 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-projects">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="800" height="800" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-5.jpg" class="attachment-full size-full wp-post-image" alt="Frame Construction" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Frame Construction</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Projects</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-1725 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-technology">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1100" height="1100" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-6.jpg" class="attachment-full size-full wp-post-image" alt="Wood Flooring" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Wood Flooring</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Technology</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-1744 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-projects">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-7.jpg" class="attachment-full size-full wp-post-image" alt="Building Systems" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Building Systems</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Projects</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-2090 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-projects">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-8.jpg" class="attachment-full size-full wp-post-image" alt="Let's Work Together" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Let's Work Together</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Projects</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-2107 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-technology">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-9.jpg" class="attachment-full size-full wp-post-image" alt="Make Every Work Count" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Make Every Work Count</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Technology</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-2115 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-technology">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-10.jpg" class="attachment-full size-full wp-post-image" alt="Building Smart" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Building Smart</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Technology</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-2148 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-projects">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-11.jpg" class="attachment-full size-full wp-post-image" alt="Construction Safety" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Construction Safety</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Projects</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-2151 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-projects">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-12.jpg" class="attachment-full size-full wp-post-image" alt="Building Fast" loading="lazy" />
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Building Fast</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Projects</span>
					</div>
	...
	<!-- Extra items (hidden, revealed on Load More click) -->
	<div id="bkd-extra-items" style="display:none">
<article class="mkd-pl-item mkd-item-space post-2167 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-projects">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-13.jpg" class="attachment-full size-full wp-post-image" alt="We Can Do Anything" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-13.jpg 1000w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-13-300x300.jpg 300w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-13-768x768.jpg 768w" sizes="(max-width: 1000px) 100vw, 1000px">
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">We Can Do Anything</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Projects</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-2176 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-technology">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-14.jpg" class="attachment-full size-full wp-post-image" alt="Better, Faster, Taller" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-14.jpg 1000w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-14-300x300.jpg 300w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-14-768x768.jpg 768w" sizes="(max-width: 1000px) 100vw, 1000px">
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">Better, Faster, Taller</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Technology</span>
					</div>
...
<article class="mkd-pl-item mkd-item-space post-2181 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-construction portfolio-category-projects">
	<div class="mkd-pl-item-inner">
		<div class="mkd-pli-image">
			<img width="1000" height="1000" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-15.jpg" class="attachment-full size-full wp-post-image" alt="We Can Do All" loading="lazy" srcset="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-15.jpg 1000w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-15-300x300.jpg 300w, https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/h2-port-img-15-768x768.jpg 768w" sizes="(max-width: 1000px) 100vw, 1000px">
		</div>
		<div class="mkd-pli-text-holder">
			<div class="mkd-pli-text-wrapper">
				<div class="mkd-pli-text">
					<h4 itemprop="name" class="mkd-pli-title entry-title">We Can Do All</h4>
					<div class="mkd-pli-category-holder">
						<span class="mkd-pli-category">Construction</span>
						<span class="mkd-pli-category">Projects</span>
					</div>
	...
	<div class="mkd-pl-load-more-holder" id="bkd-load-more-holder">
		<div class="mkd-pl-load-more" style="margin-top: 36px; margin-bottom: 80px">
			<a itemprop="url" href="" target="_self" class="mkd-btn mkd-btn-large mkd-btn-solid" id="bkd-load-more-btn">    <span class="mkd-btn-text">Load More</span>    <span class="mkd-btn-icon"></span></a>		</div>
	</div>
</div>
										</div>
									</div>
...
<style id="bkd-color-override">
    body.page-id-2093 .mkd-btn.mkd-btn-solid,
    body.page-id-2093 a.mkd-btn.mkd-btn-solid {
    ...
    body.page-id-2093 .mkd-btn.mkd-btn-solid:hover,
    body.page-id-2093 a.mkd-btn.mkd-btn-solid:hover {
        background-color: #C0392B !important;
        background-image: linear-gradient(135deg, #C0392B 0%, #9B1B1B 100%) !important;
        border-color: #C0392B !important;
    }
    body.page-id-2093 .mkd-btn.mkd-btn-solid .mkd-btn-text { color: #ffffff !important; }
    body.page-id-2093 .mkd-btn.mkd-btn-solid .mkd-btn-icon {
        background-color: #C0392B !important;
        color: #ffffff !important;
    }

    body.page-id-2093 .mkd-main-menu > ul > li.mkd-active-item > a,
    body.page-id-2093 .mkd-main-menu > ul > li.mkd-active-item > a span,
    body.page-id-2093 .mkd-main-menu > ul > li.current-menu-item > a,
    body.page-id-2093 .mkd-main-menu > ul > li > a:hover,
    body.page-id-2093 .mkd-main-menu > ul > li > a:hover span { color: #E8612D !important; }
    body.page-id-2093 .mkd-main-menu > ul > li.mkd-active-item > a::after,
    body.page-id-2093 .mkd-main-menu > ul > li > a:hover::after { background-color: #E8612D !important; }

    body.page-id-2093 .mkd-drop-down .second .inner ul li a:hover,
    body.page-id-2093 .mkd-drop-down .second .inner ul li.current-menu-item > a { color: #E8612D !important; }

    body.page-id-2093 .mkd-st-title-line { background-color: #E8612D !important; }

    body.page-id-2093 .mkd-back-to-top a,
    body.page-id-2093 #mkd-back-to-top a { background-color: #E8612D !important; }

    body.page-id-2093 .mkd-page-footer,
    body.page-id-2093 .mkd-footer-top-holder,
    body.page-id-2093 .mkd-footer-bottom-holder { background-color: #2B2B2B !important; }
    body.page-id-2093 .mkd-footer-top-holder *,
    body.page-id-2093 .mkd-footer-bottom-holder * { color: #cccccc !important; }
    body.page-id-2093 .mkd-widget-title,
    body.page-id-2093 .mkd-footer-top-holder h4,
    body.page-id-2093 .mkd-footer-bottom-holder h4 { color: #ffffff !important; }
    body.page-id-2093 .mkd-footer-top-holder a:hover,
    body.page-id-2093 .mkd-footer-bottom-holder a:hover { color: #E8612D !important; }

    body.page-id-2093 .mkd-pl-filter-holder ul li.mkd-pl-current span,
    body.page-id-2093 .mkd-pl-filter-holder ul li:hover span { color: #E8612D !important; }
</style>
...
<!-- Load More interactive behaviour -->
<script>
(function () {
    var btn = document.getElementById('bkd-load-more-btn');
    var holder = document.getElementById('bkd-load-more-holder');
    var loading = document.querySelector('.mkd-pl-loading');
    var extra = document.getElementById('bkd-extra-items');
    var grid = document.querySelector('.mkd-pl-inner');
    if (!btn || !loading || !extra || !grid) return;
    ...
    btn.addEventListener('click', function (e) {
        ...
        setTimeout(function () {
            // Move extra items into grid
            var items = extra.querySelectorAll('.mkd-pl-item');
            items.forEach(function (item) {
                grid.appendChild(item);
            });
            extra.remove();

            // Hide loading, hide load-more permanently
            loading.style.display = 'none';
            holder.remove();

            // Re-trigger layout if isotope/masonry is active
            if (window.jQuery) {
                var $grid = jQuery(grid);
                if ($grid.data('isotope')) {
                    $grid.isotope('appended', jQuery(items));
                    $grid.isotope('layout');
                }
            }
        }, 900);
