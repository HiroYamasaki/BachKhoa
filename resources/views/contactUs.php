...
<head>
	...
	<title>Contact Us &#8211; BachKhoa Digital</title>
...
.bk-contact-form input[type="submit"] {
    background: #E8612D;
    background-image: linear-gradient(135deg, #E8612D 0%, #C0392B 100%);
    color: #fff;
    border: none;
    padding: 14px 40px;
	...
	<div class="mkd-separator" style="border-color: rgba(255,255,255,0);border-style: solid;width: 15px"></div>
												...
												<div class="second">
													<div class="inner">
														<ul>
															...
															<li id="sticky-nav-menu-item-550" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-51 current_page_item "><a href="/contact-us" class=""><span class="item_outer"><span class="item_text">Contact Us</span><span class="plus"></span></span></a></li>
														</ul>
													</div>
												</div>
											</li>
							...
							<ul id="menu-main-menu-navigation-2" class="">
								...
								<li id="mobile-menu-item-380" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children mkd-active-item has_sub"><a href="#" class=" current  mkd-mobile-no-link"><span>Pages</span></a><span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>
									<ul class="sub_menu">
										...
										<li id="mobile-menu-item-550" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-51 current_page_item "><a href="/contact-us" class=""><span>Contact Us</span></a></li>
									</ul>
								</li>
							</ul>
						</div>
			...
			<div class="mkd-content" style="margin-top: -80px">
				<div class="mkd-content-inner">
					...
					<!-- Title/Hero Area -->
					<div class="mkd-title-holder mkd-centered-type mkd-preload-background mkd-has-bg-image mkd-bg-parallax" style="height: 595px;background-image:url(https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/p2-title-contact-img-1.jpg);" data-height="515">
						<div class="mkd-title-image">
							<img itemprop="image" src="https://baumeister.qodeinteractive.com/wp-content/uploads/2017/11/p2-title-contact-img-1.jpg" alt="Contact Us" />
						</div>
						<div class="mkd-title-wrapper" style="height: 515px;padding-top: 80px">
							<div class="mkd-title-inner">
								<div class="mkd-grid">
									<h1 class="mkd-page-title entry-title" style="color: #ffffff">Liên Hệ</h1>
									<p class="mkd-page-subtitle" style="color: #ffffff;padding: 0 16%">Hãy liên hệ với chúng tôi để được tư vấn giải pháp công nghệ phù hợp nhất cho doanh nghiệp của bạn. Đội ngũ BachKhoa Digital luôn sẵn sàng hỗ trợ.</p>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="mkd-grid-row">
								<div class="mkd-page-content-holder mkd-grid-col-12">
									<section class="wpb-content-wrapper">
										<div class="mkd-row-grid-section-wrapper mkd-content-aligment-left" style="background-color:#ffffff">
											<div class="mkd-row-grid-section">
												<div class="vc_row wpb_row vc_row-fluid" style="padding-top:79px;padding-bottom:72px">
													<!-- LEFT: Info -->
														...
														<div class="vc_column-inner">
															<div class="wpb_wrapper">
																<div class="mkd-elements-holder mkd-one-column mkd-responsive-mode-768">
																	<div class="mkd-eh-item" data-item-class="mkd-eh-custom-1722" data-768-1024="3px 0 73px 0" data-680-768="3px 0 70px 0" data-680="5px 0 75px 0">
																		<div class="mkd-eh-item-inner">
																			<div class="mkd-eh-item-content mkd-eh-custom-1722" style="padding: 10px 0 0 0">

																				<div class="mkd-section-title-holder mkd-st-standard mkd-st-title-left mkd-st-normal-space">
																					<div class="mkd-st-inner">
																						<h3 class="mkd-st-title" style="color: #1b1b1b">Điền Thông Tin</h3>
																						<p class="mkd-st-text" style="line-height: 30px;margin-top: 34px">
																							Vui lòng điền đầy đủ thông tin bên dưới, đội ngũ BachKhoa Digital sẽ liên hệ lại với bạn trong thời gian sớm nhất để tư vấn giải pháp phù hợp.
																						</p>
																					</div>
																				</div>
																				...
																				<div class="mkd-iwt clearfix mkd-iwt-icon-left mkd-iwt-icon-tiny">
																					<div class="mkd-iwt-icon">
																						<a itemprop="url" href="#" target="_self">
																							<span class="mkd-icon-shortcode mkd-normal mkd-icon-tiny" data-hover-color="#1b1b1b" data-color="#E8612D">
																								<i class="mkd-icon-font-awesome fa fa-map-pin mkd-icon-element" style="color: #E8612D"></i>
																							</span>
																						</a>
																					</div>
																				...
																				<div class="mkd-iwt clearfix mkd-iwt-icon-left mkd-iwt-icon-tiny">
																					<div class="mkd-iwt-icon">
																						<a itemprop="url" href="tel:+84903646288" target="_self">
																							<span class="mkd-icon-shortcode mkd-normal mkd-icon-tiny" data-hover-color="#1b1b1b" data-color="#E8612D">
																								<i class="mkd-icon-font-awesome fa fa-phone mkd-icon-element" style="color: #E8612D"></i>
																							</span>
																						</a>
																					</div>
																					<div class="mkd-iwt-content">
																						<p class="mkd-iwt-text" style="color: #8b8b8b;margin-top: 4px">0903 646 288</p>
																					</div>
																				</div>
																				...
																				<div class="mkd-iwt clearfix mkd-iwt-icon-left mkd-iwt-icon-tiny">
																					<div class="mkd-iwt-icon">
																						<a itemprop="url" href="mailto:info@bachkhoadigital.com" target="_self">
																							<span class="mkd-icon-shortcode mkd-normal mkd-icon-tiny" data-hover-color="#1b1b1b" data-color="#E8612D">
																								<i class="mkd-icon-font-awesome fa fa-envelope mkd-icon-element" style="color: #E8612D"></i>
																							</span>
																						</a>
																					</div>
																					<div class="mkd-iwt-content">
																						<p class="mkd-iwt-text" style="margin-top: 4px">info@bachkhoadigital.com</p>
																					</div>
																				</div>
													...
													<!-- RIGHT: Contact Form -->
													<div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-offset-0 vc_col-lg-6 vc_col-md-offset-0 vc_col-md-12 vc_col-sm-offset-0 vc_col-xs-12">
														<div class="vc_column-inner" style="padding-top: 10px;">
															<div class="wpb_wrapper">
																<div class="bk-contact-form">
																	...
																	<div class="mkd-grid-row">
																		<div class="mkd-grid-col-12">
																			<textarea name="message" rows="10" placeholder="Nội dung tin nhắn"></textarea>
																		</div>
																	</div>
																	<div class="mkd-grid-row">
																		<div class="mkd-grid-col-12">
...
<style id="bkd-color-override">
    body.page-id-51 .mkd-btn.mkd-btn-solid,
    body.page-id-51 a.mkd-btn.mkd-btn-solid,
    body.page-id-51 a.mkd-btn.mkd-btn-medium.mkd-btn-solid,
    body.page-id-51 a.mkd-btn.mkd-btn-small.mkd-btn-solid,
    body.page-id-51 a.mkd-btn.mkd-btn-large.mkd-btn-solid,
    body.page-id-51 a.mkd-btn.mkd-btn-full-width.mkd-btn-solid,
    body.page-id-51 a.mkd-btn.mkd-btn-solid.mkd-btn-icon {
    ...
    body.page-id-51 .mkd-btn.mkd-btn-solid:hover,
    body.page-id-51 a.mkd-btn.mkd-btn-solid:hover {
        background-color: #C0392B !important;
        background-image: linear-gradient(135deg, #C0392B 0%, #9B1B1B 100%) !important;
        border-color: #C0392B !important;
    }
    body.page-id-51 .mkd-btn.mkd-btn-solid .mkd-btn-text,
    body.page-id-51 a.mkd-btn.mkd-btn-solid .mkd-btn-text { color: #ffffff !important; }
    body.page-id-51 .mkd-btn.mkd-btn-solid .mkd-btn-icon,
    body.page-id-51 a.mkd-btn.mkd-btn-solid .mkd-btn-icon {
        background-color: #C0392B !important;
        color: #ffffff !important;
    }

    body.page-id-51 .mkd-main-menu > ul > li.mkd-active-item > a,
    body.page-id-51 .mkd-main-menu > ul > li.mkd-active-item > a span,
    body.page-id-51 .mkd-main-menu > ul > li.current-menu-item > a,
    body.page-id-51 .mkd-main-menu > ul > li > a:hover,
    body.page-id-51 .mkd-main-menu > ul > li > a:hover span { color: #E8612D !important; }
    body.page-id-51 .mkd-main-menu > ul > li.mkd-active-item > a::after,
    body.page-id-51 .mkd-main-menu > ul > li > a:hover::after { background-color: #E8612D !important; }

    body.page-id-51 .mkd-drop-down .second .inner ul li a:hover,
    body.page-id-51 .mkd-drop-down .second .inner ul li.current-menu-item > a { color: #E8612D !important; }

    body.page-id-51 .mkd-st-title-line { background-color: #E8612D !important; }

    body.page-id-51 .mkd-back-to-top a,
    body.page-id-51 #mkd-back-to-top a { background-color: #E8612D !important; }

    body.page-id-51 .mkd-page-footer,
    body.page-id-51 .mkd-footer-top-holder,
    body.page-id-51 .mkd-footer-bottom-holder { background-color: #2B2B2B !important; }
    body.page-id-51 .mkd-footer-top-holder *,
    body.page-id-51 .mkd-footer-bottom-holder * { color: #cccccc !important; }
    body.page-id-51 .mkd-widget-title,
    body.page-id-51 .mkd-footer-top-holder h4,
    body.page-id-51 .mkd-footer-bottom-holder h4 { color: #ffffff !important; }
    body.page-id-51 .mkd-footer-top-holder a:hover,
    body.page-id-51 .mkd-footer-bottom-holder a:hover { color: #E8612D !important; }
</style>
