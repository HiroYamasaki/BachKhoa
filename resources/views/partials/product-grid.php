...
<li class="product type-product status-publish <?php echo $posClass; ?> <?php echo $stockClass; ?> <?php echo $hasSale ? 'sale' : ''; ?> has-post-thumbnail shipping-taxable purchasable product-type-simple">
	<div class="mkd-pl-inner"><a href="/product-detail?id=<?php echo $product->id; ?>" class="mkd-pl-image" style="display:block;text-decoration:none;color:inherit;">
	...
	<span class="button product_type_simple add_to_cart_button">Xem chi tiết</span>
	</div></div></div></a></div><div class="mkd-pl-text-wrapper"><div class="mkd-pl-title-price-holder"><h5 class="mkd-product-list-title"><a href="/product-detail?id=<?php echo $product->id; ?>"><?php echo htmlspecialchars($product->name); ?></a></h5>
	<span class="price">
