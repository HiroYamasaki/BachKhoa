...
<section class="mkd-side-menu">
	...
	<div id="text-7" class="widget mkd-sidearea widget_text">
		<div class="textwidget">
			<p>Bach Khoa Digital — Đối tác chuyển đổi số tin cậy của doanh nghiệp Việt Nam.</p>
		</div>
	</div>
	<div id="text-8" class="widget mkd-sidearea widget_text">
		<div class="mkd-widget-title-holder"><h4 class="mkd-widget-title">Contact</h4></div>
	...
	<div id="text-9" class="widget mkd-sidearea widget_text">
		<div class="mkd-widget-title-holder"><h4 class="mkd-widget-title">Share</h4></div>
		<div class="textwidget"></div>
	</div>
