...
<!-- WordPress inline vars - MUST be before scripts that use them -->
...
/* Slider title color handled in style.css */
...
</div><div id="media_image-5" class="widget widget_media_image mkd-top-bar-widget"><img width="49" height="25" src="{{ asset('images/map_banner.png') }}" class="image wp-image-1063  attachment-full size-full" alt="a" loading="lazy" style="width:49px;height:25px;object-fit:contain;flex-shrink:0;" /></div>											</div>
				</div>
			</div>
...
<nav class="mkd-main-menu mkd-drop-down mkd-default-nav">
    <ul id="menu-main-menu-navigation" class="clearfix"><li id="nav-menu-item-379" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="/about-us" class=""><span class="item_outer"><span class="item_text">Giới thiệu</span></span></a></li>
...
<nav class="mkd-main-menu mkd-drop-down mkd-sticky-nav">
    <ul id="menu-main-menu-navigation-1" class="clearfix"><li id="sticky-nav-menu-item-379" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="/about-us" class=""><span class="item_outer"><span class="item_text">Giới thiệu</span><span class="plus"></span></span></a></li>
...
<ul class="sub_menu">
	<li id="mobile-menu-item-544" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-385 current_page_item "><a href="/" class=""><span>Main Home</span></a></li>
...
-->						</rs-slide>
    ...
    </div></div><div class="vc_empty_space"   style="height: 33px"><span class="vc_empty_space_inner"></span></div></div></div></div></div></div></div>
...
<div class="mkd-row-grid-section-wrapper " ><div class="mkd-row-grid-section"><div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1511784322626" ><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner"><div class="wpb_wrapper"><div class="mkd-elements-holder   mkd-four-columns  mkd-responsive-mode-1024 " ><div class="mkd-eh-item   mkd-horizontal-alignment-center "  data-item-class="mkd-eh-custom-2202" data-768-1024="0 22%" data-680-768="0 22%" data-680="0 5%">
    ...
    </div><div class="mkd-eh-item    " style="background-image: url({{ asset('images/gpcdstd.jpg') }})" data-item-class="mkd-eh-custom-1154" data-1024-1280="55% 0">
...
<!--
							--><rs-layer
								...
								data-type="image"
								data-rsp_ch="on"
								data-xy="x:c,c,c,c;xo:0,0,0,0;y:m;"
								data-text="l:22;a:inherit;"
								data-dim="w:1219px,1000px,600px,320px;h:645px,529px,318px,170px;"
								data-frame_0="o:1;"
								data-frame_1="sR:10;"
							...
							--><rs-layer
								...
								data-type="text"
								data-rsp_ch="on"
								data-xy="x:c;xo:-10px,-8px,-5px,-2px;y:m;yo:185px,150px,100px,55px;"
								data-text="l:22;a:inherit;"
								data-dim="w:40px,40px,32px,24px;h:60px,60px,48px,36px;"
...
-->						</rs-slide>
			...
			<!-- END REVOLUTION SLIDER -->
</div></div></div></div></div><div class="vc_row wpb_row vc_row-fluid vc_row-o-content-middle vc_row-flex mkd-content-aligment-center" ><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner"><div class="wpb_wrapper"><a itemprop="url" href="/contact-us" target="_self" class="bkd-cta-btn" style="display:flex;align-items:center;justify-content:center;width:100%;background:#E8612D;background-image:linear-gradient(135deg,#E8612D 0%,#C0392B 100%);border:none;text-decoration:none;cursor:pointer;">
	...
	<div class="mkd-separator" style="border-color: #fff;border-style: solid;width: 250px;border-bottom-width: 1px;margin-top: 17px;margin-bottom: 14px"></div>
		...
		</div><div id="media_image-3" class="widget mkd-footer-column-4 widget_media_image" style="text-align:center;"><a href="https://www.google.com/maps/place/544+Union+Ave,+Brooklyn,+NY+11211,+USA/@40.7171278,-73.9540194,17z/data=!3m1!4b1!4m13!1m7!3m6!1s0x89c24fa5d33f083b:0xc80b8f06e177fe62!2sNew+York,+NY,+USA!3b1!8m2!3d40.7127753!4d-74.0059728!3m4!1s0x89c2595bc660ec21:0x3131cdc6602b7460!8m2!3d40.7171238!4d-73.9518307" target="_blank" rel="noopener"><img width="270" height="142" src="{{ asset('images/map_footter.png') }}" class="image wp-image-3375  attachment-full size-full bk-footer-map" alt="a" loading="lazy" style="max-width: 100%; height: auto; display:block; margin:0 auto;" /></a></div>				</div>
					</div>
	</div>
