...
<defs>
<filter id="bkd-hw-glow-1" x="-30%" y="-30%" width="160%" height="160%">
...
<circle class="bkd-runner" cx="60" cy="6" r="6" fill="#ffffff" stroke="#E8612D" stroke-width="2.5" filter="url(#bkd-hw-glow-1)"/>
...
<svg viewBox="0 0 120 120" width="184" height="184">
<defs>
<filter id="bkd-hw-glow-2" x="-30%" y="-30%" width="160%" height="160%">
<feGaussianBlur stdDeviation="2.5" result="blur"/>
<feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge>
</filter>
</defs>
...
stroke-dasharray="0 339.292" stroke-dashoffset="0"
stroke-linecap="round" transform="rotate(-90 60 60)"/>
<circle class="bkd-runner" cx="60" cy="6" r="6" fill="#ffffff" stroke="#E8612D" stroke-width="2.5" filter="url(#bkd-hw-glow-2)"/>
<circle class="bkd-runner-dot" cx="60" cy="6" r="2.5" fill="#E8612D"/>
</svg>
<span class="bkd-donut-val" style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:48px;font-weight:700;color:#2b2b2b;font-family:'Oswald',sans-serif;">0<span style="font-size:20px;position:relative;top:-16px;font-weight:600;">%</span></span>
</div>
...
<svg viewBox="0 0 120 120" width="184" height="184">
<defs>
<filter id="bkd-hw-glow-3" x="-30%" y="-30%" width="160%" height="160%">
<feGaussianBlur stdDeviation="2.5" result="blur"/>
<feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge>
</filter>
</defs>
...
stroke-dasharray="0 339.292" stroke-dashoffset="0"
stroke-linecap="round" transform="rotate(-90 60 60)"/>
<circle class="bkd-runner" cx="60" cy="6" r="6" fill="#ffffff" stroke="#E8612D" stroke-width="2.5" filter="url(#bkd-hw-glow-3)"/>
<circle class="bkd-runner-dot" cx="60" cy="6" r="2.5" fill="#E8612D"/>
</svg>
<span class="bkd-donut-val" style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:48px;font-weight:700;color:#2b2b2b;font-family:'Oswald',sans-serif;">0<span style="font-size:20px;position:relative;top:-16px;font-weight:600;">%</span></span>
</div>
